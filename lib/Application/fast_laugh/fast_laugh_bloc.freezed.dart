...
mixin _$FastLaughState {
  List<DownloadsResultData> get videoList => throw _privateConstructorUsedError;
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<DownloadsResultData> videoList, bool isLoading, bool isError});
}
...
class _$_Initial implements _Initial {
  const _$_Initial(
      {required final List<DownloadsResultData> videoList,
  ...
  @override
  List<DownloadsResultData> get videoList {

...
mixin _$HomeState {
  ...
  List<NewAndHotResult> get pastYearMovieList =>
      throw _privateConstructorUsedError;
  List<NewAndHotResult> get trendingMovieList =>
      throw _privateConstructorUsedError;
  List<NewAndHotResult> get tenseDramasMovieList =>
      throw _privateConstructorUsedError;
  List<NewAndHotResult> get southIndianMovieList =>
      throw _privateConstructorUsedError;
  List<NewAndHotResult> get topTrendingTvList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<NewAndHotResult> trendingMovieList,
      List<NewAndHotResult> tenseDramasMovieList,
      List<NewAndHotResult> southIndianMovieList,
      List<NewAndHotResult> topTrendingTvList,
      bool isLoading,
      bool isError});
}
    ...
    return _then(_value.copyWith(
      ...
      southIndianMovieList: null == southIndianMovieList
          ...
          : southIndianMovieList // ignore: cast_nullable_to_non_nullable
              as List<NewAndHotResult>,
      topTrendingTvList: null == topTrendingTvList
          ? _value.topTrendingTvList
          : topTrendingTvList // ignore: cast_nullable_to_non_nullable
              as List<NewAndHotResult>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<NewAndHotResult> trendingMovieList,
      required final List<NewAndHotResult> tenseDramasMovieList,
      required final List<NewAndHotResult> southIndianMovieList,
      required final List<NewAndHotResult> topTrendingTvList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        ...
        _topTrendingTvList = topTrendingTvList;
  ...
  final List<NewAndHotResult> _trendingMovieList;
  @override
  List<NewAndHotResult> get trendingMovieList {
  ...
  final List<NewAndHotResult> _tenseDramasMovieList;
  @override
  List<NewAndHotResult> get tenseDramasMovieList {
  ...
  final List<NewAndHotResult> _topTrendingTvList;
  @override
  List<NewAndHotResult> get topTrendingTvList {
    if (_topTrendingTvList is EqualUnmodifiableListView)
      return _topTrendingTvList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_topTrendingTvList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tenseDramasMovieList: $tenseDramasMovieList, southIndianMovieList: $southIndianMovieList, topTrendingTvList: $topTrendingTvList, isLoading: $isLoading, isError: $isError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._topTrendingTvList, _topTrendingTvList) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_topTrendingTvList),
      isLoading,
      isError);

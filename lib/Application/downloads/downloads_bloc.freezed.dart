...
mixin _$DownloadsState {
  ...
  List<DownloadsResultData> get downloads => throw _privateConstructorUsedError;
  Option<Either<MainFailure, List<DownloadsResultData>>>
      get downloadsFailureOrSuccess => throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      {bool isLoading,
      List<DownloadsResultData> downloads,
      Option<Either<MainFailure, List<DownloadsResultData>>>
    ...
    return _then(_value.copyWith(
      ...
      downloadsFailureOrSuccess: null == downloadsFailureOrSuccess
          ...
          : downloadsFailureOrSuccess // ignore: cast_nullable_to_non_nullable
              as Option<Either<MainFailure, List<DownloadsResultData>>>,
    ) as $Val);
  }
}
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      required final List<DownloadsResultData> downloads,
      required this.downloadsFailureOrSuccess})
      : _downloads = downloads;

  @override
  final bool isLoading;
  final List<DownloadsResultData> _downloads;
  @override
  List<DownloadsResultData> get downloads {
  ...
  @override
  final Option<Either<MainFailure, List<DownloadsResultData>>>
      downloadsFailureOrSuccess;
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final List<DownloadsResultData> downloads,
      required final Option<Either<MainFailure, List<DownloadsResultData>>>

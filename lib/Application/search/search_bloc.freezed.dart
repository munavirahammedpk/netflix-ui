...
mixin _$SearchState {
  ...
  List<DownloadsResultData> get idleList => throw _privateConstructorUsedError;
...
abstract class $SearchStateCopyWith<$Res> {
  ...
  $Res call(
      {bool isLoading,
      bool isError,
      List<DownloadsResultData> idleList,
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      ...
      required final List<DownloadsResultData> idleList,
  ...
  @override
  final bool isError;
  final List<DownloadsResultData> _idleList;
  @override
  List<DownloadsResultData> get idleList {
